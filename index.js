...
/* customerName: Declare a variable in global scope called customerName 
...
those things we would never want to do normally, but is good for us 
...
in global scope, by writing a new function called overwriteBestCustomer() 
...
Now declare a constant (using the const keyword) in global scope called
 leastFavoriteCustomer; be sure to assign it some initial value. 
 Finally, write a function called changeLeastFavoriteCustomer() that 
 attempts to change that constant - notice what JavaScript does when 
 you try to change the constant. */
 
const leastFavoriteCustomer = 'mina'
function changeLeastFavoriteCustomer() {
    leastFavoriteCustomer = 'gertrude'
}